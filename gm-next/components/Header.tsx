      ...
      <nav className="w-full">
        <div className="flex flex-row justify-between items-center py-4 w-full px-8">
          <div className="flex items-center">
            <a href="/">
              <Image src="/assets/gridmonitor-logo.png" alt="Logo" width={240} height={51} />
            </a>
          </div>
          <ul className="flex justify-center space-x-12 text-base items-center">
            <li><a href="/about" className="text-gray-700 hover:text-blue-700">About</a></li>
            <li><a href="/contact" className="text-gray-700 hover:text-blue-700">Contact Us</a></li>           
            <li><a href="/trial" className="text-gray-700 hover:text-blue-700">Start free trial</a></li>           
            <li>
              <a href="/login" className="text-blue-400 hover:text-blue-900">Login</a>
            </li>
            <li>
              <a
                href="/demo"
